										...
										<td class=clsValue1>
											<cfoutput>
												<cfif ArrayContains(SESSION.VARS.PERMISSION,"7003")>
													...
													<cfelse>
														<input type="number" class="form-control" id="Rating" name="Rating" min="1" max="5" value="1" onblur="JSVCNumLOC(this,1,5,null,null,null,null,null,false,false,alertmsg)" CHKREFORMAT="^([0-9]{1})$" CHKREQUIRED readonly>
												</cfif>		
											</cfoutput>								
										</td>
									</tr>
